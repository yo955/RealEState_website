...
const ApartmentCard = ({ apartment }) => {
  ...
  return (
    <div className="card hover:shadow-lg transition-all duration-150">
      ...
      >
        <span
          className={`absolute w-1/4 text-center  justify-center inline-table items-center  top-6 left-1 z-10 rounded-r-lg px-4 py-1 text-xl font-medium uppercase tracking-wide text-white ${statusColors[apartment.status]}`}
        >
